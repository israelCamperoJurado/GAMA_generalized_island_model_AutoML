# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 15:41:06 2021
...
class Gama(ABC):
    ...
    def __init__(
        ...
        print("self._max_eval_time", self._max_eval_time)
        # self._time_manager = TimeKeeper(max_total_time) #Let's save this step for fit method
    ...
    def fit(
        ...
        # print("New time is", max_total_time)
        self._max_eval_time = max_total_time
        print("self._max_eval_time", self._max_eval_time)
