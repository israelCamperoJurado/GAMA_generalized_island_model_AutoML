# -*- coding: utf-8 -*-
"""
Created on Mon Sep  6 20:07:41 2021
...
def pygmo_serach(
    ...
    print("Iterations to double", iters)
    ...
    while (variable_aux):
        ...
        archi = pg.archipelago(t=pg.topology(pg.ring()))
        isl1 = pg.island(algo = pg.algorithm(pg.de(gen = generations)), pop=pop)
        isl2 = pg.island(algo = pg.algorithm(pg.sade(gen = generations)), pop=pop)
        isl3 = pg.island(algo = pg.algorithm(pg.de1220(gen = generations)), pop=pop)
        isl4 = pg.island(algo = pg.algorithm(pg.gwo(gen = generations)), pop=pop)
        isl5 = pg.island(algo = pg.algorithm(pg.pso(gen = generations)), pop=pop)
        isl6 = pg.island(algo = pg.algorithm(pg.pso_gen(gen = generations)), pop=pop)
        isl7 = pg.island(algo = pg.algorithm(pg.sea(gen = generations)), pop=pop)
        isl8 = pg.island(algo = pg.algorithm(pg.bee_colony(gen = generations)), pop=pop)
        isls = [isl1, isl2, isl3, isl4, isl5, isl6, isl7, isl8]
