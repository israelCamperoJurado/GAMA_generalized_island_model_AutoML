...
def asha(
    ...
    try:
        with AsyncEvaluator() as async_:
            ...
            def start_new_job():
                individual, rung = get_job() # individual is a list? or a Individual object?
                ...
                ) # Replace this synchronous evaluation
            ...
            while (max_full_evaluations is None) or (
                ...
                # Replace from here so on with pygmo_search method
                future = operations.wait_next(async_)
                if future.result is not None:
                    rung = future.result.individual.meta["rung"] # What is run?
