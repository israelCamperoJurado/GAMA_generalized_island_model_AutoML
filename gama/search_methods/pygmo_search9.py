# -*- coding: utf-8 -*-
"""
Created on Mon Aug 23 11:11:29 2021
...
def pygmo_serach(
    ...
    with AsyncEvaluator() as async_:
        ...
        archi = pg.archipelago(n=islands, algo=algo, prob=prob, pop_size=population_size, t=pg.topology(pg.ring()))
        print("Acabo de CREAR EL ARCHIPELAGO, ESTOY EVOLUCIONANDO EN PARALELO")
        print(archi) 
        archi.evolve() 
        archi.wait()
        archi.wait_check()
