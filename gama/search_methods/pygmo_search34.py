# -*- coding: utf-8 -*-
"""
Created on Sat Aug 28 17:02:11 2021
...
def pygmo_serach(
    ...
    print("La longitud del warm-starting es:", len(lista_aux))
    with open(path, 'wb') as f:
    ...
    #         f_vectors[i] = -10000
    #     pop.push_back(x = x_vectors[i], f = [-f_vectors[i]])
    # archi = pg.archipelago(n=8, algo=algo, pop=pop, t=pg.topology(pg.ring()))
