# -*- coding: utf-8 -*-
"""
Created on Tue Aug 24 11:46:15 2021
...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 24 11:33:57 2021
...
class AutoMLProblem:
    ...
    # Define objectives
    def fitness(self, x):
        AutoMLProblem.x_to_save.append(x)
        ...
        individual_to_use = loss_function(self.operator, individual_from_x, AutoMLProblem.contador)
        AutoMLProblem.save_whiout_evaluation.append(individual_to_use)
        # self.output.append(individual_to_use)
        print("Individuo evaluado en PyGMO Search Multi Archipelago", individual_to_use)
...
# with open('x_to_save.csv', newline='') as f:
#     reader = csv.reader(f)
#     x_vectors = list(reader)

# print(x_vectors)

# with open('f_to_save.csv', newline='') as f:
#     reader = csv.reader(f)
#     f_to_save = list(reader)
