# -*- coding: utf-8 -*-
"""
Created on Tue Aug 24 20:45:52 2021
...
class AutoMLProblem:
    ...
    def fitness(self, x):
        ...
        AutoMLProblem.f_to_save.append(f1)
        # if len(AutoMLProblem.x_to_save) == 20:
        #     import numpy as np
        #     # using the savetxt 
        #     # from the numpy module
        #     np.savetxt("x_to_save.csv", 
        #                AutoMLProblem.x_to_save,
        #                delimiter =", ", 
        #                fmt ='% s')
        #     np.savetxt("f_to_save.csv", 
        #                AutoMLProblem.f_to_save,
        #                delimiter =", ", 
        #                fmt ='% s')
        if f1 == -np.inf:
            f1 = 10000
...
def pygmo_serach(
    ...
    with AsyncEvaluator() as async_:
        ...
        for i in x_of_island_champion:
            ...
            individual_to_use = loss_function(ops, individual_from_x, 1)
