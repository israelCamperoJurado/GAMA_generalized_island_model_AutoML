# -*- coding: utf-8 -*-
"""
Created on Thu Aug 12 15:06:56 2021
...
from gama.search_methods.pygmo_search12 import SearchPygmo #EL PERRRON
...
if __name__ == '__main__':
    ...
    automl = GamaClassifier(max_total_time=60000, store="nothing", search=SearchPygmo()) # n_jobs=-1
    # automl = GamaClassifier(max_total_time=20, store='models') 
