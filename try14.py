# -*- coding: utf-8 -*-
"""
Created on Tue Aug 31 22:48:32 2021
...
if __name__ == '__main__':
    ...
    automl = GamaClassifier(max_total_time=600, store="nothing", search=RandomSearch())
    #automl = GamaClassifier(max_total_time=600, store="nothing", search=AsyncEA())
