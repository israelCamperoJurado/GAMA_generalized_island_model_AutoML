# -*- coding: utf-8 -*-
"""
Created on Sat Sep 11 15:32:21 2021
        ...
        if individual_from_x == None:
            ...
            try:
                ...
                if -f1 < self.old_loss:
                    ...
                    self.name = self.name_previous + "_" + str(uuid.uuid4())
                    path_use = os.getcwd()
                    path = path_use.replace(os.sep, '/')
                    path = path + "/pickle_gama/" + self.name + ".pkl"
...
def pygmo_serach(
    ...
    print("Iterations Sucessive", iters)
    ...
    print("poblacion final", current_population)
